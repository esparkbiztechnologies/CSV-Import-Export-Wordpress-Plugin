<?php
/*
Plugin Name: ESB CSV Import - Export
Plugin URI: https://wordpress.org/plugins/esb-csv-import-export/
Description: Handles to csv import - export posts, pages and custom post types also import - export categories.
Version: 1.1.0
Author: Henry
